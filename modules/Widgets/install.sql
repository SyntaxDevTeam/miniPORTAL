CREATE TABLE widgets (
    ...
    definition_id VARCHAR(96) NOT NULL DEFAULT '',
    ...
    INDEX idx_widgets_definition (definition_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO widgets
    (widget_key, definition_id, name, widget_type, placement, theme_name, title, content, content_format, sort_order, is_visible)
VALUES
    ('syntax-terminal', 'widgets.terminal', 'Terminal SyntaxDevTeam', 'terminal', 'hero_aside', '*',
     'syntaxdevteam.pl/build',
     'Starting SyntaxDevTerminal...
CoreAuth          READY
CorePages         READY
ThemeEngine       ONLINE
