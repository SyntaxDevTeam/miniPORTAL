CREATE TABLE team_members (
    ...
    featured_projects TEXT NOT NULL,
    profile_url VARCHAR(500) NOT NULL DEFAULT '',
    contact_email VARCHAR(190) NOT NULL DEFAULT '',
    contact_discord VARCHAR(120) NOT NULL DEFAULT '',
    primary_cta_label VARCHAR(80) NOT NULL DEFAULT '',
    primary_cta_url VARCHAR(500) NOT NULL DEFAULT '',
    secondary_cta_label VARCHAR(80) NOT NULL DEFAULT '',
    secondary_cta_url VARCHAR(500) NOT NULL DEFAULT '',
