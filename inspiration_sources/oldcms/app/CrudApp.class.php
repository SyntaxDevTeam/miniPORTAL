...
class CrudApp
{
    ...
    private function __construct(array $config = [])
    {
        ...
        // Sprawdź, czy połączenie z bazą danych zostało nawiązane poprawnie
    ...
    private function buildDatabaseConfig(array $config): array
    {
        $defaults = [
            // [required]
            'database_type' => self::constantValue(['DBDRIVER', 'DB_DRIVER'], 'mysql'),
            'server' => self::constantValue(['DBHOST', 'DB_HOST'], '127.0.0.1'),
            'database_name' => self::constantValue(['DBNAME', 'DB_NAME'], ''),
            'username' => self::constantValue(['DBUSER', 'DB_USER'], ''),
            'password' => self::constantValue(['DBPASS', 'DB_PASS'], ''),

            // [optional]
            'charset' => self::constantValue(['DBCHARSET', 'DB_CHARSET'], 'utf8mb4'),
            'collation' => self::constantValue(['DBCOLLATION', 'DB_COLLATION'], 'utf8mb4_general_ci'),
            'port' => self::constantValue(['DBPORT', 'DB_PORT'], 3306),
    ...
    private static function constantValue(array $names, $default)
    {
