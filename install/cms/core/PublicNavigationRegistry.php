...
final class PublicNavigationRegistry
{
    ...
    /**
     * @param array<string, string|array{label?: string, main?: bool, footer?: bool, area?: string, order?: int}> $settings
     * @return list<array{
     *     id: string,
     *     label: string,
    ...
    public function items(array $settings = []): array
    {
        ...
        foreach ($this->items as $id => $item) {
            ...
            if (is_string($setting)) {
                ...
                $item['order'] = max(0, min(65535, (int) ($setting['order'] ?? $item['order'])));
