...
4. Uzupełnij dane strony i bazy, wybierz co najmniej jednego dostawcę logowania
   oraz moduły.
5. Po instalacji przejdź do `/admin/login`. Pierwsze poprawne logowanie zostanie
