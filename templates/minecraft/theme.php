...
namespace SyntaxDevTeam\Cms\Templates\MinecraftTheme;
...
final class Theme implements ThemeInterface
{
    ...
    public function render_homepage(array $sections, array $pages, bool $authenticated): void
    {
        ...
        echo '<link rel="stylesheet" href="' . $this->asset('css/minecraft.css') . '"></head>';
        echo '<body class="minecraft-theme" hx-boost="true" hx-target="#content" hx-select="#content" ';
        echo 'hx-swap="innerHTML show:window:top" hx-push-url="true">';
        ...
        echo '<script src="https://cdn.jsdelivr.net/npm/htmx.org@2.0.6/dist/htmx.min.js" crossorigin="anonymous"></script>';
    ...
    private function renderPublicNavbar(array $pages, bool $authenticated, array $sections = [], bool $fixed = false): void
    {
        ...
        echo '<li class="nav-item ms-lg-2"><a class="btn btn-sm btn-outline-light" hx-boost="false" href="';
    ...
    private function renderPublicFooter(array $pages): void
    {
        ...
        echo '<a class="text-secondary" hx-boost="false" href="https://syntaxdevteam.pl/p/miniportal">miniPORTAL</a>';
        echo $this->appVersion !== '' ? ' <span class="text-secondary">v' . $this->escape($this->appVersion) . '</span>' : '';
        echo ' by ';
        echo '<a class="text-secondary" hx-boost="false" href="https://syntaxdevteam.pl">SyntaxDevTeam</a></span>';
    ...
    public function start_page(string $title, string $description = '', bool $indexable = true): void
    {
        ...
        echo '<link rel="stylesheet" href="' . $this->asset('css/stylebook.css') . '">';
        echo '<link rel="stylesheet" href="' . $this->asset('css/homepage.css') . '">';
        echo '<link rel="stylesheet" href="' . $this->asset('css/minecraft.css') . '">';
        echo '</head><body class="minecraft-theme" hx-boost="true" hx-target="#content" hx-select="#content" ';
        echo 'hx-swap="innerHTML show:window:top" hx-push-url="true"><a class="visually-hidden-focusable skip-link" href="#content">Skip to content</a>';
    ...
    public function start_admin_page(string $title, array $menuItems, string $activePath, array $user): void
    {
        ...
        echo '<link rel="stylesheet" href="' . $this->asset('css/minecraft.css') . '">';
        echo '</head><body class="admin-stylebook minecraft-theme"><div class="site-grid" aria-hidden="true"></div>';
    ...
    public function render_admin_access_state(
        ...
        echo '<link rel="stylesheet" href="' . $this->asset('css/admin.css') . '">';
        echo '<link rel="stylesheet" href="' . $this->asset('css/minecraft.css') . '">';
        echo '</head><body class="admin-stylebook minecraft-theme"><main class="container min-vh-100 d-grid align-items-center py-5">';
    ...
    public function render_admin_identities(
        ...
        echo '<link rel="stylesheet" href="' . $this->asset('css/admin.css') . '">';
        echo '<link rel="stylesheet" href="' . $this->asset('css/minecraft.css') . '">';
        echo '</head><body class="admin-stylebook minecraft-theme"><main class="container py-5">';
    ...
    private function renderHomepageTerminalWidget(array $widget, bool $authenticated): void
    {
        ...
        echo '<span aria-hidden="true">player@spawn:~$</span>';
    ...
    private function asset(string $relativePath): string
    {
        ...
        return '/templates/minecraft/assets/' . $relativePath . '?v=' . rawurlencode($version);
    }
